...
const handleSignUp = async(e)=>{
  ...
  return (
    <div className="text-white w-full h-dvh bg-black p-2 flex flex-col md:flex-row md:justify-between items-center">
  <ToastContainer />

  <div className="hidden md:block md:w-full  flex items-center justify-center w-full h-full ">
    <img className="h-[45rem]" src={login_img} alt="doodle" />
  </div>

  <div className="bg-grey_custom p-6 flex flex-col items-center justify-center w-full h-full md:w-[80%] rounded-lg">
    <h1 className="text-3xl mt-4">Whispr</h1>
    <h1 className="text-4xl font-semibold mt-12">Welcome</h1>
    <p className="mt-4 font-light">Please enter your details</p>

    <form
      className="h-full w-full md:w-[60%] mt-14"
